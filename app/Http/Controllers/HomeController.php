...
//            $datatables =  app('datatables')->of()
            ...
            ->addColumn('actions', function ($prospect) {
                ...
                $actions .= '<a class="deleteVisit" data-toggle="modal" data-target="#deleteProsp" href="#" data-delete="'.route('deleteThisProspect',["id"=>$prospect->id]).'""> <img src="' . asset("img/003-delete-copie.png") . '" onmouseover="hover(this,\'' . asset("img/003-delete.png") . '\');" onmouseout="unhover(this,\'' . asset("img/003-delete-copie.png") . '\');"></a>';
