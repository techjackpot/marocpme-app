...
$api->version('v1', ['middleware' => 'api.auth'], function ($api)  {
    ...
    $api->put('/edit/{id}',['uses'=>'HomeController@editProspectDetails','as'=>'ProspectEdit']);
    $api->delete('/destroy/{id}',['uses'=>'HomeController@editProspectDetails','as'=>'ProspectEdit']);

    $api->post('/AddNewProspect', 'HomeController@saveProspect')->name('checkObjM');
});
